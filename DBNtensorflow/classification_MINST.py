...
print(type(datasets[0]),np.shape(datasets[0]),datasets[0][0])
print(type(datasets[1]),np.shape(datasets[1]),datasets[1][0])
print(type(datasets[2]),np.shape(datasets[2]),datasets[2][0])
print(type(datasets[3]),np.shape(datasets[3]),datasets[3][0])
